app.controller("LoginController", ['$scope','$rootScope', 'LoginService', 'UsersService', '$cookieStore', '$window', function($scope, $rootScope, LoginService, UsersService, $cookieStore, $window) {
